...
export function ProductCard({ product }: ProductCardProps) {
  return (
    <Card className="flex flex-col overflow-hidden border-none shadow-lg transition-transform duration-300 hover:scale-105 hover:shadow-2xl bg-card/50 backdrop-blur-sm">
